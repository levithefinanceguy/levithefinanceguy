export interface BlogPost {
  ...
  date: string;
  description: string;
  category: "finance" | "health" | "markets" | "lifestyle";
  author: string;
  readingTime: string;
  content: string;
}
...
If you have not read [Atomic Habits](https://amzn.to/4t7asXx), seriously go grab it. It is the best investment you will make this year.`,
  },
  {
    ...
    title: "I Started Investing with $1. Here's What Happened.",
    date: "2026-03-23",
    description:
...
Track every dollar. I promise it will change your life.`,
  },
  {
    ...
    date: "2026-03-20",
    description:
      "Transparency builds trust. Here is why I let everyone see exactly what I invest in and how it performs.",
    category: "finance",
    author: "Levi",
    readingTime: "4 min read",
    content: `Most finance creators will tell you what to buy but never show you what they actually own. That always bothered me.
